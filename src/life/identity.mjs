...
export const DECODER_HASH = keccak256(toUtf8Bytes('phenotype-loci/3')); // catalog id; not in genomeHash
...
export function birthHash({life, genesisRoot, seed}) {
  ...
  return keccak256(abi.encode(['bytes32','bytes32','bytes32','uint32'], [BIRTH_DOMAIN, life, genesisRoot, seed]));
}
